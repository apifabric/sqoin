...
@Component({
  selector: 'UserGroup-home',
  templateUrl: './UserGroup-home.component.html',
  styleUrls: ['./UserGroup-home.component.scss']
})
export class UserGroupHomeComponent implements AfterViewInit {
