...
@Component({
  selector: 'UserActivityLog-home',
  templateUrl: './UserActivityLog-home.component.html',
  styleUrls: ['./UserActivityLog-home.component.scss']
})
export class UserActivityLogHomeComponent implements AfterViewInit {
