...
@Component({
  selector: 'AuditLog-home',
  templateUrl: './AuditLog-home.component.html',
  styleUrls: ['./AuditLog-home.component.scss']
})
export class AuditLogHomeComponent implements AfterViewInit {
