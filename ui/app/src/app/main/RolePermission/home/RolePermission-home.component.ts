...
@Component({
  selector: 'RolePermission-home',
  templateUrl: './RolePermission-home.component.html',
  styleUrls: ['./RolePermission-home.component.scss']
})
export class RolePermissionHomeComponent implements AfterViewInit {
